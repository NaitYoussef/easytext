...
import javamodularity.easytext.analysis.factory.AnalyzerAlgorithme;
...
public class Main {
   ...
   public static void main(String... args) throws IOException {
      ...
      System.out.println("Flesch-Kincaid: " + AnalyzerFactory.getAnalyzer(AnalyzerAlgorithme.FLESH_KINCAID).analyze(sentences));
